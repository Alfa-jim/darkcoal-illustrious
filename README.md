# darkcoal-illustrious

> Fork of [runpod-workers/worker-comfyui](https://github.com/runpod-workers/worker-comfyui) — same ComfyUI serverless API, but the baked model is swapped to [OnomaAIResearch/Illustrious-XL-v2.0](https://huggingface.co/OnomaAIResearch/Illustrious-XL-v2.0) (anime SDXL, ~6.5 GB checkpoint). Built for a rented RunPod **4090 24 GB**.

[![GHCR](https://img.shields.io/badge/ghcr.io-Alfa--jim%2Fdarkcoal--illustrious-blue)](https://github.com/Alfa-jim/darkcoal-illustrious/pkgs/container/darkcoal-illustrious)

> Upstream: [ComfyUI](https://github.com/comfyanonymous/ComfyUI) as a serverless API on [RunPod](https://www.runpod.io/)
